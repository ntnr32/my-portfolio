    ...
    return (
        <nav className="top-0 left-0 fixed h-20 flex justify-between my-4 px-10 min-w-full">
            ...
            <div className='flex p-4 gap-4'>
                <Button className='uppercase sr-only' variant='regular' leadIcon={<VscMenu />} >Menu</Button>
                <NavButton className='uppercase sr-only' variant='outline' tailIcon={<VscComment />} >Get in touch</NavButton>
            </div>
        </nav >
    )
}
